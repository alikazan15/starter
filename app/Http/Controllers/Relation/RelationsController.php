...
class RelationsController extends Controller
{
    ...
    public function getUserHasPhone()
    {
        ...
        bass hayde el tari2a afdal ikteba bi method getUserWhereHasPhoneWithCondition()
        */
    ...
    public function getHospitalDoctors()
    {
        ...
        $doctor = Doctor::find(3); //jibet el doctor li ismo اية محمد

        return $doctor->hospital->name; //jibet el mistashfa ta3ito
